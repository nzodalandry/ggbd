...
import controlleur.ControlleurCarteRegion;
...
public class Carte extends ImageScrollable {
    ...
    private final Color itineraire_couleur_depart = Color.ORANGE;
    private final Color itineraire_couleur_arrivee = Color.CYAN;
    ...
    private Color itineraire_couleur = Color.RED;
    private boolean itineraire_point_unique_est_point_depart = true;
    
    // Données du point le plus proche
    private final Color point_proche_couleur = Color.RED;
    ...
    private final Color rectangle_couleur_fond = new Color(200, 255, 100);
	...
	private void init(){
		...
		choix_depart = new JMenuItem("Definir comme point de depart", icone_depart);
		choix_depart.setForeground(Color.ORANGE);
		choix_depart.setFont(new Font("Segoe UI", Font.BOLD, 14));
		...
		menu.addSeparator();
		choix_arrivee = new JMenuItem("Definir comme point de destination", icone_arrivee);
		choix_arrivee.setForeground(Color.CYAN);
		choix_arrivee.setFont(new Font("Segoe UI", Font.BOLD, 14));
		choix_arrivee.setName("choix_arrivee");
		menu.add(choix_arrivee);
		
		// Option "Changer la couleur du tracé"
		choix_itineraire_couleur = new JMenuItem();
	
		//menu.add(choix_itineraire_couleur);
		setItineraireCouleur(itineraire_couleur);
		
		// Option "Filtre anti-aliasing"
		choix_anti_aliasing = new JCheckBoxMenuItem();
		choix_anti_aliasing.setSelected(false);
    ...
    public void ajouterEcouteurCarte(ControlleurCarteRegion ecouteur) {
